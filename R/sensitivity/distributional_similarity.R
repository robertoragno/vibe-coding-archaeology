...
# Complementary analysis (not a robustness check): does the LLM recommendation
# vector resemble the post-2023 method mix more than the pre-2023 mix?
#
...
md <- c(
  ...
  "",
  sprintf("Script: `R/sensitivity/distributional_similarity.R`  "),
